 ...
 * TimerServlet1和TimerServlet测试比较load-on-startup的顺序
 */
...
public class TimerServlet1 extends HttpServlet{
	...
	private final static Logger logger = Logger.getLogger(TimerServlet1.class);
	...
	public void init(ServletConfig config) throws ServletException{
    	...
    	Timer t = new Timer(1000,new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				logger.info("TimerServlet1:"+df.format(new Date()));
			}
		});
    	//t.start();
    }
